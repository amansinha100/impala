...
public class ExprRewriteRulesTest extends FrontendTestBase {
  ...
  public void testConvertToCNFRule() throws ImpalaException {
    ExprRewriteRule rule = ConvertToCNFRule.TEST_INSTANCE;
    ...
    RewritesOk("(int_col > 10 AND float_col < 5.0) OR (int_col < 20 AND float_col > 15.0)", rule,
            "float_col < 5.0 OR float_col > 15.0 AND float_col < 5.0 OR int_col < 20 " +
                    "AND int_col > 10 OR float_col > 15.0 AND int_col > 10 OR int_col < 20");
